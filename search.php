<script type="text/javascript">
    function cartAlerts(cart){
        switch(cart){
                ...
                case 3://bok successfully added to cart
...
<head>
    ...
    <title>Bookshop  - Search Book</title>
            ...
            if (isset($_GET['search'])) {
                ...
                $query = "SELECT
                          ...
                          FROM
                                book 
                          WHERE
                                bookName LIKE '%$searchKeyword%' OR bookISBN LIKE '%$searchKeyword%' OR bookAuthor LIKE '%$searchKeyword%'
                          ORDER BY
                                bookName ASC";
                ...
                if (mysqli_num_rows($result) > 0) {
                    ...
                    echo "<form method=\"POST\" action=\"search.php?search=$searchKeyword\">";
